        ...
        <GridItem>
          <FormControl mt={3}>
            ...
            <HStack>
              ...
              />
              <Box
                bg={Object.keys(chatbotWidget).length && chatbotWidget.primaryColor}
                borderRadius={"8px"}
        ...
        <GridItem>
          <FormControl mt={3}>
            ...
            <HStack>
              ...
              />
              <Box
                bg={Object.keys(chatbotWidget).length && chatbotWidget.fontColor}
                borderRadius={"8px"}
                border={"1px solid black"}
                h={"2.5rem"}
                w={"2.5rem"}
      ...
      >
        ...
        <FormControl mt={3}>
          ...
          <HStack alignItems={"center"} mt={"5px"}>
            <Avatar src={Object.keys(chatbotWidget).length && chatbotWidget.botIcon && chatbotWidget.botIcon}></Avatar>
            <FormLabel
              p={1}
