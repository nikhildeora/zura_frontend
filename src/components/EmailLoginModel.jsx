          ...
          <ModalContent>
            ...
            <ModalBody pb={6}>
                <FormControl isInvalid={isInputInvalid}>
                    ...
                    <Input type='email' placeholder='Enter your email to Login' value={email} onChange={(e)=>setEmail(e.target.value)} required={true}/>
                    <FormErrorMessage>{errorMessage}</FormErrorMessage>
                </FormControl>
            </ModalBody>
  
            <ModalFooter>
              <Button onClick={handleSubmit} bgColor={"var(--primary-color)"}
              mr={3}
              color={"white"}
              _hover={{
