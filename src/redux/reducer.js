import { USER_LOGIN, CREATE_NEW_PROJECT, GET_ALL_PROJECTS, USER_LOGGEDIN, CREATE_NEW_FILE, GET_ALL_FILES, CHANGE_FILE_DESCRIPTION, DELETE_FILE, CHANGE_USER_DETAIL, LOADING_TRUE, CLEAR_ERROR, CLEAR_SUCCESS, ERROR } from "./actionTypes";
